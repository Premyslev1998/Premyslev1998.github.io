/*
	Данный файл используется для выпонения заранее скомпилированной/странслированной
	интерпретатором программы.
*/
﻿
#include <fstream>
#include <iostream>
...
int main(int argc, char **argv)
{
    ...
    unsigned char memory[15000]; // общая память, на 15к элментов, или 15к байтов.
    short regs[8]; //массив под регистры целых чисел (а также &pc, &sp)
    float regsFloat[8]; //массив под регистры вещественных чисел
    short &pc=regs[6]; //массив в котором хран. номер, текущей выполняемой команды
    short &sp=regs[5]; //мыассив, в котором хранится указатель на вершину стека
	...
	*/
	//В след. 11-ти строчках c++-кода, мы открываем, скомпилированный (двоичный) файл,
    //считываем из него информацию, в общую о/п (массив - memory). 
