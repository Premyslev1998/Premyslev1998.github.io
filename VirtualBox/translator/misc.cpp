...
//------------------------------------------------------------------------------------------
//Данная ф-ия проверяет, явл. ли переданая строка - числом.
//Возвращает true, если все символы в переданной строке - числовые.  
...
//------------------------------------------------------------------------------------------
//Следующая ф-ия разделяет строку по отступам.
