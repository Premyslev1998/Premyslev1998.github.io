			...
			<table class="form-table">
                ...
                <tr valign="top"><th scope="row"><?php _e( 'Веб-сайт', 'sampletheme' ); ?></th>
                    <td>
                        ...
                        <label class="description" for="sample_theme_options[sitetext]"></label>
                    </td>
                </tr>
                <tr valign="top"><th scope="row"><?php _e( 'Адрес', 'sampletheme' ); ?></th>
                    <td>
                        ...
                        <label class="description" for="sample_theme_options[addresstext]"></label>
                    </td>
                </tr>
				<?php
				/**
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Выберите цветову схему', 'sampletheme' ); ?></th>
					<td>
